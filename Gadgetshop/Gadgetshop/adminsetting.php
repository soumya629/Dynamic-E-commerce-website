                ...
                <form method="post">
                    <div class="p-3 py-5">
                        ...
                        <div class="mt-5 text-center">
                            ...
                            <a href="adminheader.php" type="button" class="btn btn-before bg-success" style="width: 108px; margin-left:20px;"><i class="fa-solid fa-house"></i> </a>
                        </div>
                    </div>
                </form>
            </div>
...
if (isset($_POST['save'])) {
    ...
    $session_email = $_SESSION['admin']['email'];

    // Update the userdata table
    $sql2 = "UPDATE admindata 
             SET name = '$name', email = '$email' WHERE email = '$session_email'";
